...
public class Output {
    ...
    public Output(ResultSet results) throws SQLException {
        ...
        setTransactionOutput(new TransactionOutput(Constants.getNetwork(), null,
                Tools.stringToByte(results.getString("transaction_output")), 0));
    }
    ...
    public Output(TransactionOutput o, Wallet wallet) {
        ...
        setPrivateKey(new String(Base64.encode(wallet.findKeyFromPubHash(o.getAddressFromP2PKHScript(
                Constants.getNetwork()).getHash160()).getPrivKeyBytes())));
