...
public class TestCase {
	...
	public static String channel1 = Tools
			.byteToString(Tools.stringToByte58("oVddFMVCgFRyQq7ouzHy9DW82C3sRgZZr8J7rQdDbD9G"));
	public static String channel2 = Tools
			.byteToString(Tools.stringToByte58("kBze7cTJN8i65Xfah56DF2BhAFyTnQV7vq1Hs1N591YU"));
	...
	static void testPaymentsWithRefunds(int amount) throws Exception {
		...
		try {
			...
			while (i < amount) {
				PaymentRequest newPayment = context1.getPaymentReceiveRequest(1000);
				String changedAddress = newPayment.getAddress().substring(0, 30) + "AAAA"
						+ newPayment.getAddress().substring(34);
