...
public class KeyChain {
    ...
    public void start() throws Exception {
        ...
        new DeterministicSeed(seedCode, null, passphrase, creationtime);
        ...
        for (TransactionOutput o : wallet.calculateAllSpendCandidates()) {
            ...
            if (o.getParentTransaction().getConfidence().getDepthInBlocks() >= Constants.MIN_CONFIRMATION_TIME) {
                try {
                    ...
                    output.setPrivateKey(new String(Base64.encode(wallet.findKeyFromPubHash(o.getAddressFromP2PKHScript(Constants
                            .getNetwork()).getHash160()).getPrivKeyBytes())));
